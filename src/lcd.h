...
void refreshLcdTask(void *param);
...
void initLcd()
{
  ...
  xTaskCreate(
      refreshLcdTask,   /* Function to implement the task */
      "refreshLcdTask", /* Name of the task */
      10000,            /* Stack size in words */
      NULL,             /* Task input parameter */
      1,                /* Priority of the task */
      &updateLCDHandler /* Task handle. */
  );
}
